...
export const getPlaysBySourceResolution = createAction({
  name: 'get_plays_by_source_resolution',
  displayName: 'Get Plays by Source Resolution',
  ...
  async run({ auth, propsValue }) {
    ...
    const response = await client.call('get_plays_by_source_resolution', {
