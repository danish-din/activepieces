...
export const getPlaysByTop10Platforms = createAction({
  name: 'get_plays_by_top_10_platforms',
  displayName: 'Get Plays by Top 10 Platforms',
  ...
  async run({ auth, propsValue }) {
    ...
    const response = await client.call('get_plays_by_top_10_platforms', {
