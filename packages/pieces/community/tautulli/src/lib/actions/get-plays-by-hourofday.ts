...
export const getPlaysByHourOfDay = createAction({
  name: 'get_plays_by_hourofday',
  displayName: 'Get Plays by Hour of Day',
  ...
  async run({ auth, propsValue }) {
    ...
    const response = await client.call('get_plays_by_hourofday', {
