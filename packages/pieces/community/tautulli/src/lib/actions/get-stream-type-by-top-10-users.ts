...
export const getStreamTypeByTop10Users = createAction({
  name: 'get_stream_type_by_top_10_users',
  displayName: 'Get Stream Type by Top 10 Users',
  ...
  async run({ auth, propsValue }) {
    ...
    const response = await client.call('get_stream_type_by_top_10_users', {
