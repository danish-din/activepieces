...
export const getPlaysByStreamType = createAction({
  name: 'get_plays_by_stream_type',
  displayName: 'Get Plays by Stream Type',
  ...
  async run({ auth, propsValue }) {
    ...
    const response = await client.call('get_plays_by_stream_type', {
