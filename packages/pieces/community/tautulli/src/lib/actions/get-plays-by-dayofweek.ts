...
export const getPlaysByDayOfWeek = createAction({
  name: 'get_plays_by_dayofweek',
  displayName: 'Get Plays by Day of Week',
  ...
  async run({ auth, propsValue }) {
    ...
    const response = await client.call('get_plays_by_dayofweek', {
